...
4. IF ABP project → inject `05-references/prompts/backend-prompts.md` (generic backend generation) + `06-templates/dotnet-abp/prompts.md` (ABP-specific snippets) + follow `06-templates/dotnet-abp/entity-pattern.md`
