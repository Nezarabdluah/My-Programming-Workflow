# Archived Active-Task History — pre-v8 convergence

> Archived from `.agent/04-memory/active-tasks.md` when the v8 convergence sprint began.
> Historical record only. Do not load at boot.
